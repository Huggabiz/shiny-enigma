...
interface ProjectStore {
  ...
  catalogueFilters: { search: string; category: string; subCategory: string; family: string; ranking: string; showLive: boolean; showDev: boolean; showCore: boolean; showDuo: boolean; hideUsed: boolean; excludeDiscontinued: boolean; excludeCloseOut: boolean };
  setCatalogueFilters: (f: Partial<{ search: string; category: string; subCategory: string; family: string; ranking: string; showLive: boolean; showDev: boolean; showCore: boolean; showDuo: boolean; hideUsed: boolean; excludeDiscontinued: boolean; excludeCloseOut: boolean }>) => void;
...
export const useProjectStore = create<ProjectStore>((set, get) => ({
  ...
  catalogueFilters: { search: '', category: '', subCategory: '', family: '', ranking: '', showLive: true, showDev: true, showCore: true, showDuo: true, hideUsed: false, excludeDiscontinued: false, excludeCloseOut: false },
